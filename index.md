...
<table class="fixed">
    ...
    <tr>
        ...
        <td> I am an applied statistician with a broad background in behavioral and biological sciences: <br/><br/>
            ...
            I develop experiments and the statistical tools to analyze them. I work with collaborators clarify, simplify and solve challenging interdisciplinary problems: <br/><br/>
