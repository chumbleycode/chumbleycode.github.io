...
<table class="fixed">
    ...
    <tr>
        ...
        <td> I am an applied statistician with a broad background in behavioral and biological sciences: <br/><br/>
            ...
            I develop interdisciplinary experiments and the statistical tools to analyze them. I consult on questions of statistical inference, prediction and causation: <br/><br/>
